...
class RSGNN:
    ...
    def train_adj(self, epoch, features, edge_index, labels, idx_train, idx_val):
        ...
        # total_loss = loss_gcn + args.alpha *rec_loss + args.lamb * separateloss + args.lamb1 * compactloss
...
class EstimateAdj(nn.Module):
    ...
    def construct_memory(self):
        ...
        # memory_dict['Memory'] = nn.Parameter(torch.randn(64, 20, dtype=torch.cfloat),
        #                                       requires_grad=True)
        memory_dict['Wq'] = nn.Parameter(torch.randn(1433, 64), requires_grad=True)    # project to query
    ...
    def forward(self, edge_index, features):
        ...
        rec_loss = self.reconstruct_loss(edge_index, features[:,:64])
