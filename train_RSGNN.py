...
# from models.RSGNN_M import RSGNN
# from models.RSGNN_U import RSGNN
# from models.RSGNN_L import RSGNN
...
parser.add_argument('--lamb1', type=float, default=0.05, help='lamb1 value for compact loss')
